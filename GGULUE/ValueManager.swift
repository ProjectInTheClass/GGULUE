...
//강의
var lec_1 = Lecture(IdNumber: "", attend_limit: "", attnd_free:  "", exchange:  "", flex:  "", flip:  "", hakjeom:  "", lec_name: "재료구조물성", mooc:  "", lec_prof: "서지훈", relative_assessmnet:  "", supervise: "", wait: "", lec_time: ["화(2)", "목(2)"], lec_location: "창의관114호", fivescore : [[4.1, 2.9, 3.3, 3.2, 2.8]], star_score: 2.56, self_score: 2.56)
